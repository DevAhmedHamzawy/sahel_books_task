                            ...
                            <div class="row row-xs">
                                ...
                                <div class="col-md-12 mg-t-10 mg-md-t-0">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('admin.name') }}" type="text" name="name" value="{{ $admin->name }}">
                                        @error('name')
                                ...
                                <div class="col-md-12 mg-t-10 mg-md-t-0">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" placeholder="{{ trans('admin.email') }}" type="text" name="email" value="{{ $admin->email }}">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
