						...
						<ul class="nav">
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									@switch($locale)
                                    @case('en')
                                        <a href="{{ route('language' , 'en') }}" class="d-flex  nav-item nav-link pr-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    @break
                                    @case('ar')
                                        <a href="{{ route('language' , 'ar') }}" class="d-flex  nav-item nav-link pr-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{ route('language' , 'ar') }}" class="dropdown-item d-flex ">
											<span class="avatar  mr-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egypt_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="ml-3 my-auto">
												<h6>{{ auth()->user()->name }}</h6><span>{{ Auth::user()->roles->pluck('name')[0] }}</span>
											</div>
										</div>
									</div>
									...
									<a class="dropdown-item" href="{{ route('admin.logout') }}" style="margin-top:5px;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i>{{ trans('dashboard.sign_out') }}</a>
